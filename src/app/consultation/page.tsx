  ...
  return (
    ...
    >
      <div className="flex items-start gap-6">
        <div className="text-4xl md:text-5xl font-bold text-accent flex-shrink-0">
          {stage.number}
        </div>
...
export default function ConsultationPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-24 md:pt-32 pb-16 bg-gradient-to-b from-accent/10 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed">
              Book a free consultation and discover how we can help you achieve your academic goals
            </p>
          </motion.div>
        </div>
      </section>
