    ...
    return (
        <section id="testimonials" className="relative bg-rich-beige-accent py-12 sm:py-24 overflow-hidden">
            ...
            >
                ...
                <a
                    href="#"
                    className="inline-block bg-accent hover:bg-accent-foreground text-white text-sm sm:text-base font-bold px-6 py-3 uppercase tracking-wider transition-all duration-300"
                >
